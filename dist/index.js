...
/***/ function(module, exports, __webpack_require__) {
	...
	var _whiteBoard = __webpack_require__(166);

	var _whiteBoard2 = _interopRequireDefault(_whiteBoard);

	var _tools = __webpack_require__(174);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _eventBus = __webpack_require__(167);
	...
	var WhiteBoard = function (_React$Component) {
		...
		function WhiteBoard() {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(WhiteBoard).call(this));

			_store2.default.subscribe(function () {
				_this.setState({ data: _store2.default.data });
			});
			_this.state = { data: _store2.default.data };
			_this.pressed = false;
			return _this;
		}
		...
		_createClass(WhiteBoard, [{
			...
			value: function componentDidMount() {
				...
				this.onResize();
				this.setState({ data: _store2.default.data });
			}
		}, {
			key: 'onResize',
			...
			key: '_insideRect',
			value: function _insideRect(rect, point) {
			...
			value: function mouseDown(e) {
				if (this._insideRect(this.rect, { x: e.clientX, y: e.clientY })) {
					this.pressed = true;
					_eventBus2.default.emit(_eventBus2.default.START_PATH, this.mousePos(e));
				}
			}
		}, {
			key: 'mouseMove',
			value: function mouseMove(e) {
				if (this.pressed) {
					_eventBus2.default.emit(_eventBus2.default.MOVE_PATH, this.mousePos(e));
				}
			}
		}, {
			key: 'mouseUp',
			value: function mouseUp(e) {
				this.pressed = false;
				_eventBus2.default.emit(_eventBus2.default.END_PATH, this.mousePos(e));
			}
		}, {
			key: 'keyDown',
			value: function keyDown(e) {
				switch (e.keyCode) {
					case 27:
						//escape
						_eventBus2.default.emit(_eventBus2.default.UNDO);
						break;
				}
			}
		}, {
			...
			value: function render() {
				...
				var shapes = data.shapes.map(function (line, i) {
					return _react2.default.createElement(line.type, { key: i, path: line.path, color: line.color });
				});
				var current = null;
				if (data.currentLine) {
					current = _react2.default.createElement(data.currentLine.type, { color: data.currentLine.color, path: data.currentLine.path });
				}

				return _react2.default.createElement(
					'svg',
					{ id: 'whiteBoard', width: this.props.width, height: this.props.height,
						ref: function ref(c) {
							return _this2._svg = c;
						} },
					shapes,
					current
				);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _toolStore = __webpack_require__(170);
	...
	var _rect = __webpack_require__(172);

	var _rect2 = _interopRequireDefault(_rect);

	var _ellipse = __webpack_require__(173);
	...
	var Store = function () {
		function Store() {
			...
			_eventBus2.default.on(_eventBus2.default.START_PATH, this.startPath.bind(this));
			_eventBus2.default.on(_eventBus2.default.MOVE_PATH, this.movePath.bind(this));
			_eventBus2.default.on(_eventBus2.default.END_PATH, this.endPath.bind(this));
			_eventBus2.default.on(_eventBus2.default.UNDO, this.undo.bind(this));
			_eventBus2.default.on(_eventBus2.default.REDO, this.redo.bind(this));
			_eventBus2.default.on(_eventBus2.default.PICK_VERSION, this.pickVersion.bind(this));

			this.data = {
				shapes: _immutable2.default.List.of(),
				selected: [],
				currentLine: null
			};
			this.history = [this.data.shapes];
			this.historyIndex = -1;
			this.tool = _line2.default;
			this.color = 'black';

			_toolStore2.default.subscribe(function () {
				var tool = _toolStore2.default.tool;
				var map = {
					line: _line2.default,
					rect: _rect2.default,
					ellipse: _ellipse2.default
				};
				_this.tool = map[tool] || _line2.default;
				_this.color = _toolStore2.default.color;
			});
		}
		...
		_createClass(Store, [{
			...
			value: function subscribe(cb) {
				_eventBus2.default.on(this.id, cb);
			}
		}, {
			key: 'emitChanges',
			value: function emitChanges() {
				_eventBus2.default.emit(this.id);
			}
		}, {
			key: 'startPath',
			value: function startPath(event, position) {
			...
			key: 'movePath',
			value: function movePath(event, position) {
			...
			key: 'endPath',
			value: function endPath(event, position) {
			...
			key: 'pickVersion',
			value: function pickVersion(event, index) {
				console.log(index);
				if (this.history && this.history[index]) {
					this.historyIndex = index;
					var shapes = this.history[index];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ToolStore = function () {
		function ToolStore() {
			_classCallCheck(this, ToolStore);

			this.id = 'toolStore';
			_eventBus2.default.on(_eventBus2.default.TOOL_CHANGE, this.toolChange.bind(this));
			_eventBus2.default.on(_eventBus2.default.COLOR_CHANGE, this.colorChange.bind(this));
			this.tool = 'line';
			this.color = 'black';
		}
		...
		_createClass(ToolStore, [{
			...
			key: 'toolChange',
			value: function toolChange(event, tool) {
				this.tool = tool;
				this.emitChanges();
			}
		}, {
			key: 'colorChange',
			value: function colorChange(event, color) {
				this.color = color;
				this.emitChanges();
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Line = function (_React$Component) {
		...
		function Line() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(Line).call(this));
		}

		_createClass(Line, [{
			key: 'prepareData',
			value: function prepareData() {
				var d = ['M ' + this.props.path[0].x + ' ' + this.props.path[0].y];

				var collector = this.props.path.map(function (point) {
					var xNext = point.x;
					var yNext = point.y;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Rect = function (_React$Component) {
		...
		function Rect() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(Rect).call(this));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ellipse = function (_React$Component) {
		...
		function Ellipse() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(Ellipse).call(this));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _colorPicker = __webpack_require__(175);
	...
	var Tools = function (_React$Component) {
		...
		function Tools() {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Tools).call(this));

			_this.state = {
				tools: [{ label: 'fa-mouse-pointer', type: 'cursor' }, { label: 'fa-pencil', type: 'line', selected: true }, { label: 'fa-square-o', type: 'rect' }, { label: 'fa-circle-thin', type: 'ellipse' }]
			};
			_toolStore2.default.subscribe(function () {
				var toolType = _toolStore2.default.tool;
				_this.state.tools.forEach(function (tool) {
		...
		_createClass(Tools, [{
			...
			value: function handleClick(index) {
				return function () {
					_eventBus2.default.emit(_eventBus2.default.TOOL_CHANGE, this.state.tools[index].type);
				};
			}
		}, {
			key: 'render',
			value: function render() {
				...
				var tools = this.state.tools.map(function (tool, i) {
					return _react2.default.createElement(
						'div',
						{
							key: i,
							onClick: _this2.handleClick(i).bind(_this2),
							className: tool.selected ? 'selected' : ''
						},
						_react2.default.createElement('i', { className: tool.label + ' fa' })
					);
				});
				return _react2.default.createElement(
					'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ColorPicker = function (_React$Component) {
		...
		function ColorPicker() {
			...
			_toolStore2.default.subscribe(function () {
				var selectedColor = _toolStore2.default.color;
				var selectedColorIndex = _this.state.colors.indexOf(selectedColor);
				_this.setState({ selectedColorIndex: selectedColorIndex });
			});
			return _this;
		}
		...
		_createClass(ColorPicker, [{
			...
			value: function handleClick(index) {
				return function () {
					_eventBus2.default.emit(_eventBus2.default.COLOR_CHANGE, this.state.colors[index]);
				};
			}
		}, {
			key: 'render',
			value: function render() {
				...
				var colors = this.state.colors.map(function (color, i) {
					...
					var borderStyle = (_borderStyle = {
						display: 'flex',
						border: 1
					}, _defineProperty(_borderStyle, 'border', _this2.state.selectedColorIndex === i ? '1px solid' : ''), _defineProperty(_borderStyle, 'margin', 1), _borderStyle);

					return _react2.default.createElement(
						'div',
						{ key: i, style: borderStyle },
						_react2.default.createElement('div', { style: style, onClick: _this2.handleClick(i).bind(_this2) })
					);
				});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var History = function (_React$Component) {
		...
		function History() {
			...
			_store2.default.subscribe(function () {
				_this.setState({
					...
					selectedIndex: _store2.default.historyIndex
				});
			});
		...
		_createClass(History, [{
			...
			value: function handleClick(index) {
				return function () {
					_eventBus2.default.emit(_eventBus2.default.PICK_VERSION, index);
				};
			}
		}, {
			key: 'render',
			value: function render() {
				...
				var versions = this.state.history.map(function (version, i) {
					return _react2.default.createElement('span', {
						key: i,
						onClick: _this2.handleClick(i).bind(_this2),
						className: _this2.state.selectedIndex === i ? 'selected' : ''
					});
				});
				return _react2.default.createElement(
					'div',
